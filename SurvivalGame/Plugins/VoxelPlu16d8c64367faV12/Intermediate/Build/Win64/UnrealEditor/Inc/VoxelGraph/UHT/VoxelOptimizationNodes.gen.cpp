...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_CopyForTestingSPESIALworldGeneration_V2_VocselPremium_Plugins_VoxelPlu16d8c64367faV12_Source_VoxelGraph_Public_VoxelNodes_VoxelOptimizationNodes_h__Script_VoxelGraph_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UVoxelNode_StaticClampFloat, UVoxelNode_StaticClampFloat::StaticClass, TEXT("UVoxelNode_StaticClampFloat"), &Z_Registration_Info_UClass_UVoxelNode_StaticClampFloat, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_StaticClampFloat), 1827487104U) },
		{ Z_Construct_UClass_UVoxelNode_RangeAnalysisDebuggerFloat, UVoxelNode_RangeAnalysisDebuggerFloat::StaticClass, TEXT("UVoxelNode_RangeAnalysisDebuggerFloat"), &Z_Registration_Info_UClass_UVoxelNode_RangeAnalysisDebuggerFloat, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_RangeAnalysisDebuggerFloat), 1259089U) },
		{ Z_Construct_UClass_UVoxelNode_Sleep, UVoxelNode_Sleep::StaticClass, TEXT("UVoxelNode_Sleep"), &Z_Registration_Info_UClass_UVoxelNode_Sleep, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_Sleep), 2581986703U) },
		{ Z_Construct_UClass_UVoxelNode_RangeUnion, UVoxelNode_RangeUnion::StaticClass, TEXT("UVoxelNode_RangeUnion"), &Z_Registration_Info_UClass_UVoxelNode_RangeUnion, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_RangeUnion), 2942957284U) },
		{ Z_Construct_UClass_UVoxelNode_IsSingleBool, UVoxelNode_IsSingleBool::StaticClass, TEXT("UVoxelNode_IsSingleBool"), &Z_Registration_Info_UClass_UVoxelNode_IsSingleBool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_IsSingleBool), 1410329580U) },
		{ Z_Construct_UClass_UVoxelNode_GetRangeAnalysis, UVoxelNode_GetRangeAnalysis::StaticClass, TEXT("UVoxelNode_GetRangeAnalysis"), &Z_Registration_Info_UClass_UVoxelNode_GetRangeAnalysis, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_GetRangeAnalysis), 1364092055U) },
		{ Z_Construct_UClass_UVoxelNode_SmartMin, UVoxelNode_SmartMin::StaticClass, TEXT("UVoxelNode_SmartMin"), &Z_Registration_Info_UClass_UVoxelNode_SmartMin, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_SmartMin), 700143404U) },
		{ Z_Construct_UClass_UVoxelNode_SmartMax, UVoxelNode_SmartMax::StaticClass, TEXT("UVoxelNode_SmartMax"), &Z_Registration_Info_UClass_UVoxelNode_SmartMax, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_SmartMax), 4110773471U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CopyForTestingSPESIALworldGeneration_V2_VocselPremium_Plugins_VoxelPlu16d8c64367faV12_Source_VoxelGraph_Public_VoxelNodes_VoxelOptimizationNodes_h__Script_VoxelGraph_650950128(TEXT("/Script/VoxelGraph"),
	Z_CompiledInDeferFile_FID_CopyForTestingSPESIALworldGeneration_V2_VocselPremium_Plugins_VoxelPlu16d8c64367faV12_Source_VoxelGraph_Public_VoxelNodes_VoxelOptimizationNodes_h__Script_VoxelGraph_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CopyForTestingSPESIALworldGeneration_V2_VocselPremium_Plugins_VoxelPlu16d8c64367faV12_Source_VoxelGraph_Public_VoxelNodes_VoxelOptimizationNodes_h__Script_VoxelGraph_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
