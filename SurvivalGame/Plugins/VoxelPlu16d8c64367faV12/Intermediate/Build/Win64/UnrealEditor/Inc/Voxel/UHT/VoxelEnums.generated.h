...
// IWYU pragma: private, include "VoxelEnums.h"
...
#define CURRENT_FILE_ID FID_CopyForTestingSPESIALworldGeneration_V2_VocselPremium_Plugins_VoxelPlu16d8c64367faV12_Source_Voxel_Public_VoxelEnums_h
...
template<> struct TIsUEnumClass<EVoxelRenderType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelNormalConfig> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelMaterialConfig> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelUVConfig> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelRGBA> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelSpawnerActorSpawnType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelSamplerMode> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelDataType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelRGBHardness> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelFalloff> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxel32BitMask> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVoxelDataItemCombineMode> { enum { Value = true }; };
