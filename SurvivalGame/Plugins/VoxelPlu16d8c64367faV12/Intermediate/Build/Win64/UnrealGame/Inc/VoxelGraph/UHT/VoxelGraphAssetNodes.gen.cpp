...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphAssetNodes_h__Script_VoxelGraph_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UVoxelGraphAssetNode, UVoxelGraphAssetNode::StaticClass, TEXT("UVoxelGraphAssetNode"), &Z_Registration_Info_UClass_UVoxelGraphAssetNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelGraphAssetNode), 4196040257U) },
		{ Z_Construct_UClass_UVoxelNode_EditGetValue, UVoxelNode_EditGetValue::StaticClass, TEXT("UVoxelNode_EditGetValue"), &Z_Registration_Info_UClass_UVoxelNode_EditGetValue, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_EditGetValue), 1986070801U) },
		{ Z_Construct_UClass_UVoxelNode_EditGetMaterial, UVoxelNode_EditGetMaterial::StaticClass, TEXT("UVoxelNode_EditGetMaterial"), &Z_Registration_Info_UClass_UVoxelNode_EditGetMaterial, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_EditGetMaterial), 3345160391U) },
		{ Z_Construct_UClass_UVoxelNode_EditGetCustomOutput, UVoxelNode_EditGetCustomOutput::StaticClass, TEXT("UVoxelNode_EditGetCustomOutput"), &Z_Registration_Info_UClass_UVoxelNode_EditGetCustomOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_EditGetCustomOutput), 2255776848U) },
		{ Z_Construct_UClass_UVoxelNode_EditGetHardness, UVoxelNode_EditGetHardness::StaticClass, TEXT("UVoxelNode_EditGetHardness"), &Z_Registration_Info_UClass_UVoxelNode_EditGetHardness, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_EditGetHardness), 3730460688U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphAssetNodes_h__Script_VoxelGraph_808350061(TEXT("/Script/VoxelGraph"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphAssetNodes_h__Script_VoxelGraph_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphAssetNodes_h__Script_VoxelGraph_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
