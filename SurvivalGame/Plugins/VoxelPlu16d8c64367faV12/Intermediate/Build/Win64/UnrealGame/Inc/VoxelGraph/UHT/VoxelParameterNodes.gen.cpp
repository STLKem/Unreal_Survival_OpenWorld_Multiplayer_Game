...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelParameterNodes_h__Script_VoxelGraph_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UVoxelNode_FloatParameter, UVoxelNode_FloatParameter::StaticClass, TEXT("UVoxelNode_FloatParameter"), &Z_Registration_Info_UClass_UVoxelNode_FloatParameter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_FloatParameter), 1313414537U) },
		{ Z_Construct_UClass_UVoxelNode_IntParameter, UVoxelNode_IntParameter::StaticClass, TEXT("UVoxelNode_IntParameter"), &Z_Registration_Info_UClass_UVoxelNode_IntParameter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_IntParameter), 2800073099U) },
		{ Z_Construct_UClass_UVoxelNode_ColorParameter, UVoxelNode_ColorParameter::StaticClass, TEXT("UVoxelNode_ColorParameter"), &Z_Registration_Info_UClass_UVoxelNode_ColorParameter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_ColorParameter), 3636397927U) },
		{ Z_Construct_UClass_UVoxelNode_BoolParameter, UVoxelNode_BoolParameter::StaticClass, TEXT("UVoxelNode_BoolParameter"), &Z_Registration_Info_UClass_UVoxelNode_BoolParameter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_BoolParameter), 105642437U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelParameterNodes_h__Script_VoxelGraph_188363301(TEXT("/Script/VoxelGraph"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelParameterNodes_h__Script_VoxelGraph_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelParameterNodes_h__Script_VoxelGraph_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
