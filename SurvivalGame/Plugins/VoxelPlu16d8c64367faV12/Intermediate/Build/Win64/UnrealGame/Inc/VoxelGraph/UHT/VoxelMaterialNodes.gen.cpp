...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelMaterialNodes_h__Script_VoxelGraph_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UVoxelMaterialNode, UVoxelMaterialNode::StaticClass, TEXT("UVoxelMaterialNode"), &Z_Registration_Info_UClass_UVoxelMaterialNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelMaterialNode), 225899052U) },
		{ Z_Construct_UClass_UVoxelNode_GetColor, UVoxelNode_GetColor::StaticClass, TEXT("UVoxelNode_GetColor"), &Z_Registration_Info_UClass_UVoxelNode_GetColor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_GetColor), 2203864674U) },
		{ Z_Construct_UClass_UVoxelNode_GetIndex, UVoxelNode_GetIndex::StaticClass, TEXT("UVoxelNode_GetIndex"), &Z_Registration_Info_UClass_UVoxelNode_GetIndex, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_GetIndex), 3075648229U) },
		{ Z_Construct_UClass_UVoxelNode_GetUVChannel, UVoxelNode_GetUVChannel::StaticClass, TEXT("UVoxelNode_GetUVChannel"), &Z_Registration_Info_UClass_UVoxelNode_GetUVChannel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelNode_GetUVChannel), 3745468048U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelMaterialNodes_h__Script_VoxelGraph_353797994(TEXT("/Script/VoxelGraph"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelMaterialNodes_h__Script_VoxelGraph_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelMaterialNodes_h__Script_VoxelGraph_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
