...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphMacro_h__Script_VoxelGraph_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UVoxelGraphMacroInputOutputNode, UVoxelGraphMacroInputOutputNode::StaticClass, TEXT("UVoxelGraphMacroInputOutputNode"), &Z_Registration_Info_UClass_UVoxelGraphMacroInputOutputNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelGraphMacroInputOutputNode), 3271682671U) },
		{ Z_Construct_UClass_UVoxelGraphMacroInputNode, UVoxelGraphMacroInputNode::StaticClass, TEXT("UVoxelGraphMacroInputNode"), &Z_Registration_Info_UClass_UVoxelGraphMacroInputNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelGraphMacroInputNode), 3533601U) },
		{ Z_Construct_UClass_UVoxelGraphMacroOutputNode, UVoxelGraphMacroOutputNode::StaticClass, TEXT("UVoxelGraphMacroOutputNode"), &Z_Registration_Info_UClass_UVoxelGraphMacroOutputNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelGraphMacroOutputNode), 1106616687U) },
		{ Z_Construct_UClass_UVoxelGraphMacro, UVoxelGraphMacro::StaticClass, TEXT("UVoxelGraphMacro"), &Z_Registration_Info_UClass_UVoxelGraphMacro, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelGraphMacro), 442766279U) },
		{ Z_Construct_UClass_UVoxelGraphMacroNode, UVoxelGraphMacroNode::StaticClass, TEXT("UVoxelGraphMacroNode"), &Z_Registration_Info_UClass_UVoxelGraphMacroNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVoxelGraphMacroNode), 806332583U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphMacro_h__Script_VoxelGraph_3293490548(TEXT("/Script/VoxelGraph"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphMacro_h__Script_VoxelGraph_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphMacro_h__Script_VoxelGraph_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphMacro_h__Script_VoxelGraph_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_VoxelPro_Source_VoxelGraph_Public_VoxelNodes_VoxelGraphMacro_h__Script_VoxelGraph_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
